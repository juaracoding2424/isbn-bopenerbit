...
<script>
	...
	$('#btnTambahFilter').on("click", function(){
		...
		htmlAppend +='<option value="title">Judul</option><option value="kepeng">Kepengarangan</option><option value="masalah">Masalah</option><option value="tahun_terbit">Tahun Terbit</option></select>';
