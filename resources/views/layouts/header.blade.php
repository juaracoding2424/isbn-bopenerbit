							...
							<div class="app-navbar-item ms-1 ms-lg-3 me-2 me-lg-6" id="kt_header_user_menu_toggle">
								...
								<div class="cursor-pointer symbol symbol-35px symbol-md-40px"
									...
									<img class="symbol symbol-circle symbol-35px symbol-md-40px"
										src="{{ asset('assets/media/avatars/blank.png') }}" alt="user" id="imgAvatar1"/>
								</div>
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="symbol symbol-50px me-5">
												<img alt="Logo Perusahaan" src="{{ asset('assets/media/avatars/blank.png') }}" id="imgAvatar2" />
											</div>
											<!--end::Avatar-->
											<!--begin::Username-->
									...
									<div class="menu-item px-5">
										<a href="{{url('penerbit/profile')}}" class="menu-link px-5 {{ request()->is('penerbit/profile') ? 'active' : '' }}">Akun</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu separator-->
									<div class="separator my-2"></div>
									...
									<div class="menu-item px-5 my-1">
										<a href="{{url('penerbit/change-password')}}" class="menu-link px-5 {{ request()->is('penerbit/change-password') ? 'active' : '' }}">Ubah Password</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu item-->
									<div class="menu-item px-5">
