					...
					<div class="card">
						...
						@else 
							<div class="alert alert-success d-flex align-items-center p-5 mb-10">
								<i class="ki-solid ki-check fs-4hx text-success me-4"><span class="path1"></span><span class="path2"></span></i>
								<div class="rounded border p-10  d-flex flex-column">
									<div class="d-flex flex-column">
											@if(session('message'))
												<h2 class="mb-1 text-success">{{ session('message') }}</h2>
											@else
												<h2 class="mb-1 text-success">Akun Anda saat ini belum diverifikasi oleh administrator website ISBN. </h2>
											@endif
