...
Route::group(['middleware' => ProtectLoginMiddleware::class], function () {
    Route::group(['middleware' => PenerbitValidMiddleware::class], function () {
        Route::get('/', [DashboardController::class, 'layouts.index']);
        Route::get('penerbit/dashboard', [DashboardController::class, 'layouts.index']);
        ...
        Route::get('penerbit/isbn/data', [IsbnDataController::class, 'layouts.index']);
        ...
        Route::get('penerbit/kdt/data', [KDTController::class, 'layouts.index']);
        Route::get('penerbit/kdt/data/datatable', [KDTController::class, 'datatable']);

        Route::get('penerbit/isbn/masalah', [IsbnMasalahController::class, 'layouts.index']);
        Route::get('penerbit/isbn/masalah/datatable', [IsbnMasalahController::class, 'datatable']);

        Route::get('penerbit/isbn/permohonan', [IsbnPermohonanController::class, 'layouts.index']);
        ...
        Route::get('penerbit/history/data', [HistoryController::class, 'layouts.index']);

        Route::get('penerbit/report/isbn', [ReportController::class, 'layouts.index']);
        ...
        Route::get('penerbit/profile', [ProfilController::class, 'layouts.index']);
        ...
        Route::get('penerbit/change-password', [ChangePasswordController::class, 'layouts.index']);
